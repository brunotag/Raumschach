...
namespace xWinFormsLib
{
    class Border
    {
        ...
        {
            texture[0] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_upperleft");
            texture[1] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_uppercenter");
            texture[2] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_upperright");
            texture[3] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_midleft");
            texture[4] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_midcenter");
            texture[5] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_midright");
            texture[6] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_lowerleft");
            texture[7] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_lowercenter");
            if (resizable)
                texture[8] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_lowerright_resize");
            else
                texture[8] = content.Load<Texture2D>(@"textures\controls\form\" + prefix + "_lowerright");
