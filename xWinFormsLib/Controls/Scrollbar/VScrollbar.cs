...
namespace xWinFormsLib
{
    class VScrollbar: Control
    {
        ...
        {
            background = content.Load<Texture2D>(@"textures\controls\scrollbar\vscrollbar_back");

            Size = new Vector2(12, Height);

            cursorTex = content.Load<Texture2D>(@"textures\controls\scrollbar\vscrollbar_cursor");
