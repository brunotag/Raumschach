...
namespace xWinFormsLib
{
    public class Listbox : Control
    {
        ...
        public override void Initialize(ContentManager content, GraphicsDevice graphics)
        {
            ...
            pixel = new Texture2D(graphics, 1, 1, false, graphics.PresentationParameters.BackBufferFormat);
            ...
            renderTarget = new RenderTarget2D(graphics, (int)Width - 2, (int)Height);
