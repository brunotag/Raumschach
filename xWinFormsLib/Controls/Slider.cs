...
{    
    ...
    {        
        ...
        {
            //Slider
            texture[0] = content.Load<Texture2D>(@"textures\controls\slider\slider_left");
            texture[1] = content.Load<Texture2D>(@"textures\controls\slider\slider_center");
            ...
            //Cursor
            texture[2] = content.Load<Texture2D>(@"textures\controls\slider\slider_cursor");
