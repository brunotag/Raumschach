...
namespace xWinFormsLib
{
    public class Listview : Control
    {
        ...
        public override void Initialize(ContentManager content, GraphicsDevice graphics)
        {
            ...
            renderTarget = new RenderTarget2D(graphics, area.Width - 2, area.Height - 2);
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            var bindings = FormCollection.Graphics.GraphicsDevice.GetRenderTargets();

            Render(FormCollection.Graphics.GraphicsDevice);

            if (bindings.Length > 0)
            {
                FormCollection.Graphics.GraphicsDevice.SetRenderTarget(bindings[0].RenderTarget as RenderTarget2D);
