    ...
    public abstract class GameScreen
    {
            ...
            else if (coveredByOtherScreen)
            {
                ...
                else
                {
                    if (screenState != ScreenState.Hidden)
                        ScreenManager.Game.GraphicsDevice.Reset();
                    // Transition finished!
        ...
        public virtual void Draw(GameTime gameTime) 
        {
            if (DebugMode)
            {
                ...
                SpriteFont font = ((Raumschach)ScreenManager.Game).spriteFont;
                ...
                foreach(System.Reflection.FieldInfo field in fields)
                {
                    ...
                    builder.Append(" = ");
                    builder.Append(field.GetValue(this));
                    builder.Append("\n");
                }

                spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend);
                spriteBatch.DrawString(font, builder.ToString(), fontPos, Color.Yellow);
                spriteBatch.End();
            }
        }
